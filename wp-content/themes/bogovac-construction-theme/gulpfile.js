let project_name = 'bogovac-construction';
...
let config = (function(){
	...
	return {
		...
		/***********************************************************************/
		text_domain: '' || project_name, // Example: 'bogovac' #lowercase, separated by underscore or dash ( _ or - )
		packageName: '' || project_name, // Example: 'bogovac package' #Capitalized
