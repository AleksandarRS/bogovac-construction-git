...
(function () {
   ...
   -------------------------------------------------------------------------------*/
		...
		var validInput = require('./site/valid-input');
   ...
   */
    ...
    */
	...
	}, { "./core/navigation": 1, "./site/example": 3, "./site/valid-input": 5, "jquery": 6 }], 3: [function (require, module, exports) {
		"use strict";
   ...
   -------------------------------------------------------------------------------*/
      ...
      */
					var sectionsInit = function sectionsInit(i, el) {
						if (i < _this.$dom.formSection.length) {
							...
							var typeEl = _this.$dom.formSectionHeading[i].querySelector('[bc-section-type]');
							if (typeEl) {
								var type = typeEl.getAttribute('bc-section-type');
								if (type == 'single-choice' || type == 'multiple-choice') {
									var label = type.split('-');
      ...
      */
					...
					var inputValidStyle = function inputValidStyle(e) {
						var isError = this.parentNode.querySelector('.frm_error');
      ...
      */
					...
					var sectionToggleCollapse = function sectionToggleCollapse(e) {
						var isCollapsed = this.parentNode.classList.contains('bc-collapse');
      ...
      */
					...
					var validateCollapse = function validateCollapse(el) {
						if (currentSectionHeading && currentSectionHeading != el) {
							var currentSection = currentSectionHeading.parentNode;
      ...
      */
					...
					var validateBody = function validateBody(e) {
						console.log(this);
						var _this = this;
      ...
      */
					...
					var validate = function validate(el) {
						...
						if (type == 'multiple-choice' || type == 'single-choice') {
							...
							var inputs = $(el.querySelectorAll('[aria-required="true"]'));
      ...
      */
					...
					var sectionScroll = function sectionScroll(el) {
						setTimeout(function () {
							window.scrollTo({
								top: el.offsetTop,
								left: 0,
      ...
      */
					...
					var getSectionType = function getSectionType(el) {
						var type = el.querySelector('[bc-section-type]');
      ...
      */
					...
					var autosaveFormSegments = function autosaveFormSegments(el) {
						var autosaveEl = el.querySelector('[bc-section-autosave]');
						if (!isAutosaveInit) {
							isAutosaveInit = autosaveEl.getAttribute('bc-section-autosave') == 'start';
						}
						var isAutosave = autosaveEl ? true : false;

						if (isAutosave) {
							var section = el.parentNode;
							var entryIndex = el.parentNode.getAttribute('bc-section-entry');
							var type = getSectionType(el);
							var values = [];

							if (type == "multiple-choice" || type == "single-choice") {
								var choices = section.querySelectorAll('input:checked');
      ...
      */
					...
					var validateSubmitReady = function validateSubmitReady() {
      ...
      */
					...
					var loop = function loop(arr, fun) {
